// <copyright file="DaprActorKeyValueProvider.cs" company="ITANEO">
...
/// <summary>
/// Provider class for creating instances of <see cref="IKeyValueStore{TKey, TState}"/>.
/// </summary>
...
public class DaprActorKeyValueProvider(
