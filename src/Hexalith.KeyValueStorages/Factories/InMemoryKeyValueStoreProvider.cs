// <copyright file="InMemoryKeyValueStoreFactory.cs" company="ITANEO">
...
/// </summary>
public class InMemoryKeyValueStoreProvider : IKeyValueStoreProvider
{
    private readonly IServiceProvider _serviceProvider;

    /// <summary>
    /// Initializes a new instance of the <see cref="InMemoryKeyValueStoreProvider"/> class.
    /// </summary>
    /// <param name="serviceProvider">The service provider to use for managing dependencies.</param>
    public InMemoryKeyValueStoreProvider([NotNull] IServiceProvider serviceProvider)
    {
